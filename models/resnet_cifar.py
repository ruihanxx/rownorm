...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, base_width: int = 64):
        super().__init__()
...
def resnet18_cifar(num_classes: int = 10, base_width: int = 64) -> ResNet:
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=base_width)
